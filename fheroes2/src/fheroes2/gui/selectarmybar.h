...
private:
    static void StatusMessageEvent1(const SelectArmyBar &, u8, const Troop &, std::string &);
    static void StatusMessageEvent2(u8, u8, const Troop &, const Troop &, bool, std::string &);
